...
public class GsonUtils {
     ...
     * @return
     */
    public static HashMap<String, Object> getJsonFromStringToMap(String jsonString) {
    ...
    private static Object getValue(String jsonValueString) {
        Object result = null;
        if (jsonValueString.startsWith("{")) {
            result = getJsonFromStringToMap(jsonValueString);
        } else if (jsonValueString.startsWith("[")) {
   ...
   public static  class JsonParser{
        ...
        /**
         * 转化List为Json  List<String> 不支持
         *
         * @param list 列表数据
         * @return
         */
        public static String parseListObject(List<?> list) {
            StringBuffer sb = new StringBuffer("");
            sb.append("[");
